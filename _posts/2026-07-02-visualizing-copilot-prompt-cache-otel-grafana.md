...
description: "Exporting GitHub Copilot prompt cache metrics with OpenTelemetry and charting them in Grafana, so a platform team can see cache behavior fleet-wide."
date: 2026-07-02
