...
description: "Building a Model Context Protocol app that renders interactive charts inside VS Code, with the entire codebase generated by GitHub Copilot."
date: 2026-01-28
...
**Note:** This example requires the [GitHub MCP Server](https://github.com/github/github-mcp-server) to also be configured. The GitHub MCP Server retrieves the data, and then the Chart App visualizes it. This demonstrates how multiple MCP servers can work together—one for data retrieval, another for presentation.
